...
const Sifat = () => {
  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto px-4 py-16 relative md:mt-0 mt-10 ">
      <div className="relative bg-[#3c3849] text-white  h-[600px] md:h-auto rounded-3xl p-6 md:p-10 lg:p-16 shadow-[0_10px_60px_-15px_rgba(255,0,90,0.4)] ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 items-center relative z-30">
          ...
          <div className="text-center md:text-left md:mt-0 mt-35 sm:mt-50 mb-5 md:mb-0">
            ...
            <p className="text-2xl md:display   md:text-white  font-light mt-2">{t("characteristic.title")}</p>
          </div>
          ...
          {/* O‘ng blok */}
          <div className="text-center md:text-left mt-5 md:mt-0 ml-3">
